function BCStheoryCriticalCurrentFit32(callback)
...
if nargin==0
    ...
    uicontrol('tag','filebox',...
        ...
        'fontname','arial',...
        'fontsize',7,...
        'callback','BCStheoryCriticalCurrentFit32(''load'')')
    uicontrol('tag','browsebutton',...
        'Units','normalized',...
        'style','pushbutton',...
        'position',[.05 .08 .1 .07],...
        'string','Load data file',...
        'callback','BCStheoryCriticalCurrentFit32(''browse'')')
    ...
    uicontrol('tag','typeIk0',...
        ...
        'string','Type I',...
        'value',0,...
        'callback','BCStheoryCriticalCurrentFit32(''typeIk0'')');
...
alphaboxw = tcboxw;
    ...
    uicontrol('tag','calcbutton',...
        ...
        'position',[.75 .1 .1 .07],...
        'string','Calc',...
        'callback','BCStheoryCriticalCurrentFit32(''calc2'')')
